...
6 年实时音视频 SDK 解决方案与客户交付经验，早期具备 4 年以上 iOS 一线开发经验。熟悉直播、语聊房、KTV/合唱、在线教育、视频通话、第三方美颜、客户接口规范适配与 SDK 再封装等 RTC 场景，能够从客户需求分析、方案设计、Demo/Wrapper 交付、问题排查到上线保障完成全链路技术支持。近一年进一步将 AI Coding、知识库和智能排障工具引入解决方案工作，提升复杂问题分析和交付效率。
...
角色：高级解决方案专家 / 方案设计 / 上线保障
关键词：RTC、SDK 接入、客户方案、上线保障、直播、语聊房、在线教育、视频通话
项目定位：面向不同行业客户的实时音视频方案交付项目，将客户业务目标抽象为 SDK 接入链路、联调清单和上线风险控制方案。
主要工作：
...
角色：方案设计 / Demo 支持 / 音频链路设计
关键词：KTV、实时合唱、单唱、伴奏播放器、SEI、音频对齐、自定义音频采集
项目定位：围绕在线 KTV、实时合唱、双人轮唱和单唱等复杂音频场景，设计完整业务流程、关键 SDK 能力组合和联调方案。
主要工作：
...
角色：方案设计 / 问题排查 / 体验优化
关键词：音频路由、声卡适配、音量调整、音质优化、外放保真、排障报告
项目定位：面向 RTC 客户现网音频体验问题，将个案排障抽象为可复用的音频链路分析、参数建议和优化方案。
主要工作：
...
### 某客户接口规范适配与 SDK 再封装项目

角色：方案设计 / iOS Wrapper 支持 / 接口联调
关键词：SDK 再封装、RTC、Wrapper、接口规范、接口适配、Demo
项目定位：面向客户既有接口规范与中台接入诉求，提供贴近客户调用习惯的 RTC Wrapper、接口适配说明和验证 Demo。
主要工作：
...
角色：架构设计 / 方案设计 / 工具实现
关键词：工作流 SOP、参数配置、方案 checklist、代码 review checklist、交付工具链
项目定位：面向内部的方案交付工具链平台，将参数配置、方案 checklist、代码 review checklist 和交付文档模板沉淀为可复用 SOP。
主要工作：
