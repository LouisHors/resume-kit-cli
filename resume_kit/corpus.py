...
def load_corpus():
    ...
    evidence = [
        ...
        _evidence(
            ...
            highlight_results=[
                "支持字节跳动、网易、好未来、SOUL、会玩、富聊、微博、Yalla、传音等客户的直播、语聊房、在线教育、视频通话等场景交付。",
                "围绕客户上线后的高频问题沉淀排查文档、参数模板和工具化能力。",
                "推动方案交付从单点支持升级为可复用的流程化交付。",
            ],
            capability_phrasing=[
        ...
        _evidence(
            ...
            highlight_results=[
                "支撑 Yalla 的直播/语聊接口适配，覆盖音频路由、设备模式和播放器参数等差异化能力。",
                "支撑字节跳动的在线教育接口适配，覆盖房间、推拉流、跨频道转发、回调和错误码。",
                "支撑好未来的 RTC 中台接口适配，降低客户中台与底层 SDK 的耦合。",
            ],
            capability_phrasing=[
        ...
        _evidence(
            ...
            highlight_results=[
                "支撑带带的声卡问题、音量调整和音质提升等音频优化工作。",
                "支撑会玩的音频体验分析与风险识别，并沉淀到智能排障系统中。",
                "支撑富聊的音频问题排查与复用材料建设，形成可复用的排障模板。",
            ],
            capability_phrasing=[
        ...
        _evidence(
            ...
            highlight_results=[
                "支撑会玩的 KTV 场景与海外合唱场景落地。",
                "支撑网易的游戏化 KTV 和合唱项目方案设计、联调与验收。",
                "支撑带带、给麦的单唱和合唱玩法接入与音频链路联调。",
            ],
            capability_phrasing=[
